...
if (!isset($_SESSION['namauser']) && !isset($_SESSION['passuser'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM tbl_produk ORDER BY id_produk DESC LIMIT 1");
    $hasil = mysqli_fetch_array($query);
    $lastid = $hasil['id_produk'];
    ...
    if ($lastid == "") {
        ...
        $id = intval($id);
        $id = ($id + 1);
        $id = "P" . str_pad($id, 4, '0', STR_PAD_LEFT);
    }
    ?>
<!-- BEGIN: Content-->
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Tambah Produk</h2>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="module/produk/aksi/aksi_simpan_produk.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="idproduk" class="form-control" name="idproduk" placeholder="ID Produk" readonly style="color: #7367F0;" value="<?=$id;?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
...
include "assets/lib/koneksi.php";
    ...
    while ($rowkategori = mysqli_fetch_array($kuerikategori)) {
        ?>
                                                                    <option value="<?=$rowkategori['id_kategori'];?>"><?=$rowkategori['nama'];?></option>
                                                                    <?php }?>
                                                                </select>
                                                            </div>
                                                        </div>
...
include "assets/lib/koneksi.php";
    ...
    while ($rowmerek = mysqli_fetch_array($kuerimerek)) {
        ?>
                                                                    <option value="<?=$rowmerek['id_merek'];?>"><?=$rowmerek['nama'];?></option>
                                                                    <?php }?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text" id="harga" class="form-control" name="harga" placeholder="Harga Produk">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text" id="stok" class="form-control" name="stok" placeholder="Stok Produk">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea id="deskripsi" class="form-control char-textarea" name="deskripsi" rows="3" placeholder="Deskripsi Produk"></textarea>
