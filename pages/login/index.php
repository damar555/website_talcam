                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Selamat datang, silakan login menggunakan akun Anda.</p>
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="aksi/login.php" method="POST">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-right"><a href="auth-forgot-password.html" class="card-link">Lupa kata sandi?</a></div>
                                                    </div>
                                                    <a href="<?php echo $admin_url; ?>" class="btn btn-outline-primary float-left btn-inline">Back to Dashboard</a>
